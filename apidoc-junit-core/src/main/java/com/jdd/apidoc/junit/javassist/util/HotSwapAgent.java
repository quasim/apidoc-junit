 ...
 * License.
 */
package com.jdd.apidoc.junit.javassist.util;
...
public class HotSwapAgent {
        ...
        throws IOException, CannotCompileException, NotFoundException
    {
        ...
        attrs.put(new Attributes.Name("Premain-Class"), com.jd.apidoc.junit.javassist.util.HotSwapAgent.class.getName());
        attrs.put(new Attributes.Name("Agent-Class"), com.jd.apidoc.junit.javassist.util.HotSwapAgent.class.getName());
        ...
        try {
            ...
            String cname = com.jd.apidoc.junit.javassist.util.HotSwapAgent.class.getName();
